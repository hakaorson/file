...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{DIP数据集}{\label{fig:chap1:zitu:a}
        \includegraphics[width=6cm]{ppi-dip}\hskip2cm}
    \subcaptionbox{Krogan数据集}{\label{fig:chap1:zitu:b}
        \includegraphics[width=6cm]{ppi-krogan}}
    \vskip0.5cm
    \subcaptionbox{biogrid数据集}{\label{fig:chap1:zitu:c}
        \includegraphics[width=6cm]{ppi-biogrid}\hskip2cm}
    \subcaptionbox{Gavin数据集}{\label{fig:chap1:zitu:d}
        \includegraphics[width=6cm]{ppi-gavin}}
